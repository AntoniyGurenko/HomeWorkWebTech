...
// это то что было на лекции можете прмотать до строки 30 - не могу смотреть на не заполненую, хочу хоть чуть-чуть чтобы было)

$name = "Иван";
$prof = "Овнер";
$city = "Мухосранск";
$email = "ivan.01@mail.ru";
